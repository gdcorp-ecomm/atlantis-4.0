...
{
  public class PLOrderLevelPromoRequestData : RequestData
  {
    ...
    public PLOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount)
    ...
    public PLOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, OrderLevelPromo orderLevelPromo)
      : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
      this._clientIP = string.Empty;
    ...
    public PLOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount,  OrderLevelPromo orderLevelPromo, string clientIP)
      : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
