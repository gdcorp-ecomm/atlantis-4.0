...
namespace Atlantis.Framework.CreatePLOrderLevelPromo.Interface
{
  ...
  public class ResellerOrderLevelPromoRequestData : RequestData
  {
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount) : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount) 
    {
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, string promoCodeToUse, string clientIP)
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, string promoCodeToUse, string clientIP, Dictionary<int, PrivateLabelPromo> resellerPromoList)
      : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
      this._promoCode = promoCodeToUse;
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, Dictionary<int, PrivateLabelPromo> resellerPromoList, string promoCodeToUse, string clientIP)
      :base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
      this._resellerList = resellerPromoList;
      this._promoCode = promoCodeToUse;
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, string promoCodeToUse, PrivateLabelPromo resellerPromo)
      : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
      this._resellerList = new Dictionary<int, PrivateLabelPromo>();
    ...
    public ResellerOrderLevelPromoRequestData(string sourceUrl, string pathway, int pageCount, string promoCodeToUse, PrivateLabelPromo resellerPromo, string clientIP)
      : base(string.Empty, sourceUrl, string.Empty, pathway, pageCount)
    {
      this._resellerList = new Dictionary<int, PrivateLabelPromo>();
      this._resellerList.Add(resellerPromo.PrivateLabelId, resellerPromo);
