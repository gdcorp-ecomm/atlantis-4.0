...
namespace Atlantis.Framework.AuthTwoFactorDeletePhone.Impl.WsgdAuthentication
{
  ...
  /// <remarks/>
    ...
    public partial class Authentication : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Authentication() {
            this.Url = global::Atlantis.Framework.AuthTwoFactorDeletePhone.Impl.Properties.Settings.Default.Atlantis_Framework_AuthTwoFactorDeletePhone_Impl_WsgdAuthentication_Authentication;
        ...
        public long DeletePendingTwoFactor(string sShopperID, string sPassword, int lPrivateLabelID, string sHostname, string sIPAddress, out string sError) {
        ...
        /// <remarks/>
        public void DeletePendingTwoFactorAsync(string sShopperID, string sPassword, int lPrivateLabelID, string sHostname, string sIPAddress) {
            this.DeletePendingTwoFactorAsync(sShopperID, sPassword, lPrivateLabelID, sHostname, sIPAddress, null);
        }
        
        /// <remarks/>
        public void DeletePendingTwoFactorAsync(string sShopperID, string sPassword, int lPrivateLabelID, string sHostname, string sIPAddress, object userState) {
