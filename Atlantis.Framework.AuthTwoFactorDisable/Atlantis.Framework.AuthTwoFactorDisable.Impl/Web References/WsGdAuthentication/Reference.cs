...
namespace Atlantis.Framework.AuthTwoFactorDisable.Impl.WsGdAuthentication
{
  ...
  /// <remarks/>
    ...
    public partial class Authentication : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Authentication() {
            this.Url = global::Atlantis.Framework.AuthTwoFactorDisable.Impl.Properties.Settings.Default.Atlantis_Framework_AuthTwoFactorDisable_Impl_WsGdAuthentication_Authentication;
        ...
        public long ChangePassword(string sLoginName, int lPrivateLabelID, string sCurrentPassword, string sNewPassword, string sNewHint, string sNewLogin, int lStrong, out string sError) {
        ...
        /// <remarks/>
        public void ChangePasswordAsync(string sLoginName, int lPrivateLabelID, string sCurrentPassword, string sNewPassword, string sNewHint, string sNewLogin, int lStrong) {
            this.ChangePasswordAsync(sLoginName, lPrivateLabelID, sCurrentPassword, sNewPassword, sNewHint, sNewLogin, lStrong, null);
        }
        
        /// <remarks/>
        public void ChangePasswordAsync(string sLoginName, int lPrivateLabelID, string sCurrentPassword, string sNewPassword, string sNewHint, string sNewLogin, int lStrong, object userState) {
