...
namespace Atlantis.Framework.BonsaiGetPlanOptions.Interface.Types
{
  public class PrepaidAddon : AddonBase
  {
    ...
    public PrepaidAddon(string name, int categoryId, string unifiedProductId, bool isQuantityBased, int minQty, int maxQty, int minDuration, int maxDuration, int increment)
