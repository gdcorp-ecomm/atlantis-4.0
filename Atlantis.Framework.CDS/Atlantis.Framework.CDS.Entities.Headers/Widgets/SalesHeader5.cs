...
{
  public class SalesHeader5 : IWidgetModel, IContent, IAddToCartWidgetModel
  {
    ...
    private List<HeadersMarketingButton> _buttons;
    public List<HeadersMarketingButton> Buttons
    {
      get
      {
        if (_buttons == null)
        {
          _buttons = new List<HeadersMarketingButton>();
        }
        return _buttons;
      }
      set
