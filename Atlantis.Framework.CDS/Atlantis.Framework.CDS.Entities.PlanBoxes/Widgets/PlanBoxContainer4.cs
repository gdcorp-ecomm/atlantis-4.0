...
{
  public class PlanBoxContainer4 : IWidgetModel
  {
    ...
    private string _orangeButtonText;
    public string OrangeButtonText
    {
      get
      {
        if (string.IsNullOrEmpty(_orangeButtonText))
        {
          _orangeButtonText = "Add to Cart";
        }
        return _orangeButtonText;
      }
      set
      {
        _orangeButtonText = value;
      }
    }
