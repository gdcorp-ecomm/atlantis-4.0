...
namespace Atlantis.Framework.CMSCreditAccounts.Impl.ActivationService
{
  ...
  /// <remarks/>
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ActivationWizardSupportSoap", Namespace="http://services.godaddy.com/")]
    public partial class ActivationWizardSupport : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback DomainListsOperationCompleted;
        ...
        /// <remarks/>
        public ActivationWizardSupport() {
            this.Url = global::Atlantis.Framework.CMSCreditAccounts.Impl.Properties.Settings.Default.Atlantis_Framework_CMSCreditAccounts_Impl_ActivationService_ActivationWizardSupport;
        ...
        /// <remarks/>
        public event DomainListsCompletedEventHandler DomainListsCompleted;
        
        /// <remarks/>
        public event IsDomainValidForInstantPageCompletedEventHandler IsDomainValidForInstantPageCompleted;
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://services.godaddy.com/DomainLists", RequestNamespace="http://services.godaddy.com/", ResponseNamespace="http://services.godaddy.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string DomainLists(string cmsCreditDomainsRequestXml) {
            object[] results = this.Invoke("DomainLists", new object[] {
                        cmsCreditDomainsRequestXml});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void DomainListsAsync(string cmsCreditDomainsRequestXml) {
            this.DomainListsAsync(cmsCreditDomainsRequestXml, null);
        }
        
        /// <remarks/>
        public void DomainListsAsync(string cmsCreditDomainsRequestXml, object userState) {
            if ((this.DomainListsOperationCompleted == null)) {
                this.DomainListsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnDomainListsOperationCompleted);
            }
            this.InvokeAsync("DomainLists", new object[] {
                        cmsCreditDomainsRequestXml}, this.DomainListsOperationCompleted, userState);
        }
        
        private void OnDomainListsOperationCompleted(object arg) {
            if ((this.DomainListsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DomainListsCompleted(this, new DomainListsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void DomainListsCompletedEventHandler(object sender, DomainListsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DomainListsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DomainListsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
