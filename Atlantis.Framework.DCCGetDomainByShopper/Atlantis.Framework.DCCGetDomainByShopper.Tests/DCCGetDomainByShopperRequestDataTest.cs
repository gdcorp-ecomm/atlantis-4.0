...
namespace Atlantis.Framework.DCCGetDomainByShopper.Tests
{
  ...
  public class DCCGetDomainByShopperRequestDataTest
  {
    ...
    public void GetCacheMD5Test()
    {
      ...
      var request = new DCCGetDomainByShopperRequestData("859148", paging, "MOBILE_CSA_DCC");
      ...
      var request2 = new DCCGetDomainByShopperRequestData("859148", paging, "MOBILE_CSA_DCC");
      ...
      var request3 = new DCCGetDomainByShopperRequestData("859148", paging, "MOBILE_CSA_DCC");
