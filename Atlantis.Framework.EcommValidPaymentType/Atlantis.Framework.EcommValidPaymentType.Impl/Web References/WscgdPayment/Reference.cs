...
namespace Atlantis.Framework.EcommValidPaymentType.Impl.WscgdPayment {
    ...
    public partial class WSCgdPaymentTypesService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetActivePaymentTypesExOperationCompleted;
        ...
        /// <remarks/>
        public event GetActivePaymentTypesExCompletedEventHandler GetActivePaymentTypesExCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("#GetActivePaymentTypesEx", RequestNamespace="urn:WSCgdPaymentTypesService", ResponseNamespace="urn:WSCgdPaymentTypesService")]
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public int GetActivePaymentTypesEx(string bstrRequestXML, out string pbstrOutput) {
            object[] results = this.Invoke("GetActivePaymentTypesEx", new object[] {
                        bstrRequestXML});
            pbstrOutput = ((string)(results[1]));
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public void GetActivePaymentTypesExAsync(string bstrRequestXML) {
            this.GetActivePaymentTypesExAsync(bstrRequestXML, null);
        }
        
        /// <remarks/>
        public void GetActivePaymentTypesExAsync(string bstrRequestXML, object userState) {
            if ((this.GetActivePaymentTypesExOperationCompleted == null)) {
                this.GetActivePaymentTypesExOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetActivePaymentTypesExOperationCompleted);
            }
            this.InvokeAsync("GetActivePaymentTypesEx", new object[] {
                        bstrRequestXML}, this.GetActivePaymentTypesExOperationCompleted, userState);
        }
        
        private void OnGetActivePaymentTypesExOperationCompleted(object arg) {
            if ((this.GetActivePaymentTypesExCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetActivePaymentTypesExCompleted(this, new GetActivePaymentTypesExCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void GetActivePaymentTypesExCompletedEventHandler(object sender, GetActivePaymentTypesExCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetActivePaymentTypesExCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetActivePaymentTypesExCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
