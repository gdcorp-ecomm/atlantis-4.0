...
{
  public static class CartBasketOrderDetailProperty
  {
    ...
    public const string MarketplaceShippingTotal = "_marketplace_shipping_total";
    public const string MarketplaceShopList = "_marketplace_shop_list";
    ...
    public const string BillToFax = "bill_to_fax";
    public const string BillToMiddleName = "bill_to_middle_name";
    ...
    public const string DiscountsApplied = "_discounts_applied";
    public const string DiscountUpsells = "_discount_upsells";
  }
}
