...
namespace Atlantis.Framework.GoodAsGoldReport.Tests
{
  ...
  public class GetReport
  {
    ...
    public void GetReportTest()
    {
      ...
      GoodAsGoldReportRequestData request = new GoodAsGoldReportRequestData("867900", string.Empty, string.Empty, string.Empty, 0, sdate, edate, 5, 2, "displayDate", "asc", "Withdrawal");
