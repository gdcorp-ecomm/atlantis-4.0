...
namespace Atlantis.Framework.AddCommercialVote.Impl.CommercialVoteAddWS {
    using System;
    ...
    public partial class GuestbookService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public GuestbookService() {
            this.Url = global::Atlantis.Framework.AddCommercialVote.Impl.Properties.Settings.Default.Atlantis_Framework_AddCommercialVote_Impl_CommercialVoteAddWS_GuestbookService;
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAddGuestbookEntry(int guestbookId, string domain, WsComment wsComment, int commercialType, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("AddGuestbookEntry", new object[] {
                        guestbookId,
                        domain,
                        wsComment,
                        commercialType}, callback, asyncState);
        }
        
        /// <remarks/>
        public GuestbookResultEnum EndAddGuestbookEntry(System.IAsyncResult asyncResult) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAddCommercialVote(string commercial, string shopperId, string clientIp, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("AddCommercialVote", new object[] {
                        commercial,
                        shopperId,
        ...
        /// <remarks/>
        public int EndAddCommercialVote(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
