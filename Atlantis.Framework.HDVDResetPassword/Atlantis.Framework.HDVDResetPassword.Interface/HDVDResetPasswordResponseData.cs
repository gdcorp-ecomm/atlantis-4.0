...
{
  [DataContract]
  public class HDVDResetPasswordResponseData : IResponseData
  {
    private readonly AtlantisException _ex;
    private AriesHostingResponse response;

    public HDVDResetPasswordResponseData(RequestData request, Exception ex)
    {
      _ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
    }

    public HDVDResetPasswordResponseData(AtlantisException aex)
    {
      _ex = aex;
    }

    public HDVDResetPasswordResponseData(AriesHostingResponse response)
    {
