...
{
  [DataContract]
  public class HDVDSubmitTroubleTicketResponseData : IResponseData
  {
    private readonly AtlantisException _ex;
    private AriesHostingResponse response;

    public HDVDSubmitTroubleTicketResponseData(RequestData request, Exception ex)
    {
      _ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
    }

    public HDVDSubmitTroubleTicketResponseData(AtlantisException aex)
    {
      _ex = aex;
    }

    public HDVDSubmitTroubleTicketResponseData(AriesHostingResponse response)
    {
