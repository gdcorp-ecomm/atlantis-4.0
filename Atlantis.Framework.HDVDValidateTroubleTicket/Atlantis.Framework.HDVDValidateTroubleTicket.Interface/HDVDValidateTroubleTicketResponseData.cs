...
{
  [DataContract]
  public class HDVDValidateTroubleTicketResponseData : IResponseData
  {
    private readonly AtlantisException _ex;
    private AriesValidationResponse response;

    public HDVDValidateTroubleTicketResponseData(RequestData request, Exception ex)
    {
      _ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
    }

    public HDVDValidateTroubleTicketResponseData(AtlantisException aex)
    {
      _ex = aex;
    }

    public HDVDValidateTroubleTicketResponseData(AriesValidationResponse response)
    {
