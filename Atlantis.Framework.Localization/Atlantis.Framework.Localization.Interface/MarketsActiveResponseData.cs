  ...
  public class MarketsActiveResponseData : IResponseData
  {
    ...
    public static MarketsActiveResponseData FromCacheDataXml(string cacheDataXml)
    {
      ...
      try
      {
        ...
        {
          var aex = new AtlantisException("Atlantis.Framework.Localization.MarketsActiveResponseData.FromCacheDataXml",
                                          "0",
      ...
      catch (Exception ex)
      {
        ...
        var aex = new AtlantisException("Atlantis.Framework.Localization.MarketsActiveResponseData.FromCacheDataXml", "0", "WS Response contains invalid XML or invalid price values.", message, null, null);
        Engine.EngineLogging.EngineLogger.LogAtlantisException(aex);
      }
