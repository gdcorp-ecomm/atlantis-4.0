  ...
  public class MyaAccordionMetaDataRequest : IRequest
  {
    public IResponseData RequestHandler(RequestData requestData, ConfigElement config)
    {
      ...
      try
      {
        ...
        string metaDataXml = BuildDebugMetaDataXml();
    ...
    private string BuildDebugMetaDataXml()
    {
      ...
      XElement accordiondata1 = new XElement("accordiondata"
        ...
        , new XAttribute("contentXml", "<content><data accountlist='mya_accountListGetHosting_sp' jsonpage='GetProductsContainer.aspx'/></content>")
      ...
      XElement accordiondata2 = new XElement("accordiondata"
        ...
        , new XAttribute("contentXml", "<content><data accountlist='mya_accountListGetEEM_sp' jsonpage='GetProductsContainer.aspx'/></content>")
      ...
      XElement accordiondata3 = new XElement("accordiondata"
        ...
        , new XAttribute("contentXml", "<content><data accountlist='mya_accountListGetEmailAllTypes_sp' jsonpage='GetProductsContainer.aspx'/></content>")
      ...
      XElement accordiondata4 = new XElement("accordiondata"
        ...
        , new XAttribute("contentXml", "<content><data accountlist='' jsonpage='domains.aspx'/></content>")
      ...
      XElement accordiondata5 = new XElement("accordiondata"
