  ...
  public class MyaAccordionMetaDataRequest : IRequest
  {
    ...
    private string BuildDebugMetaDataXml()
    {
      ...
      XElement accordiondata1 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='11111' cirenewnow='22222' cisetup='33333' controlpanelrequiresaccount='false' iconcsscoordinates='-34px,-82px,14px,12px' isproductofferedfree='true' showsetupformanageronly='false' productgroup='1' cmsdisplaygroupidlist='191' orionproductname='sharedhosting'/>")
      ...
      XElement accordiondata3 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='55555' cirenewnow='66666' cisetup='77777' controlpanelrequiresaccount='false' iconcsscoordinates='-34px,-42px,14px,12px' isproductofferedfree='true' showsetupformanageronly='false' productgroup='4' cmsdisplaygroupidlist='187,193'/>")
      ...
      XElement accordiondata4 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='98765' cirenewnow='98766' controlpanelrequiresaccount='false' iconcsscoordinates='-154px,-92px,14px,12px' isproductofferedfree='false' showsetupformanageronly='false' productgroup='30' cmsdisplaygroupidlist='186,189,190'/>")
      ...
      XElement accordiondata6 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='54059' cirenewnow='54061' cisetup='54062' controlpanelrequiresaccount='true' iconcsscoordinates='155px,93px,30px,30px' isproductofferedfree='true' showsetupformanageronly='false' productgroup='15' cmsdisplaygroupidlist='192'/>")
