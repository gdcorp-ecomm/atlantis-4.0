  ...
  public class MyaAccordionMetaDataRequest : IRequest
  {
    ...
    private string BuildDebugMetaDataXml()
    {
      ...
      XElement accordiondata6 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='54059' cirenewnow='54061' cisetup='54062' controlpanelrequiresaccount='true' iconcsscoordinates='155px,93px,30px,30px' isproductofferedfree='true' showsetupformanageronly='false' />")
      ...
      XElement accordiondata7 = new XElement("item"
        ...
        , new XAttribute("accordionXml", "<accordion ciexpansion='54068' cirenewnow='54070' controlpanelrequiresaccount='true' iconcsscoordinates='31px,0px,30px,30px' isproductofferedfree='false' showsetupformanageronly='false' />")
