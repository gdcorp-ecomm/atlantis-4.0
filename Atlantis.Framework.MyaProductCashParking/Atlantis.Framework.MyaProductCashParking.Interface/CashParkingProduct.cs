...
{
  public class CashParkingProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.CashParking; }
    }
    ...
    public CashParkingProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
