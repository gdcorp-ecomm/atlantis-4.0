...
namespace Atlantis.Framework.PayeeDisplay.Impl.PayeeWS {
    using System;
    ...
    public partial class WSCgdCAPService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WSCgdCAPService() {
            this.Url = global::Atlantis.Framework.PayeeDisplay.Impl.Properties.Settings.Default.Atlantis_Framework_PayeeDisplay_Impl_PayeeWS_WSCgdCAPService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("#ShopperHasAccount", RequestNamespace="urn:WSCgdCAPService", ResponseNamespace="urn:WSCgdCAPService")]
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public short ShopperHasAccount(string bstrShopperID, out string pbstrErrorDesc) {
            object[] results = this.Invoke("ShopperHasAccount", new object[] {
                        bstrShopperID});
            pbstrErrorDesc = ((string)(results[1]));
            return ((short)(results[0]));
        }
        
        /// <remarks/>
        public void ShopperHasAccountAsync(string bstrShopperID) {
            this.ShopperHasAccountAsync(bstrShopperID, null);
        }
        
        /// <remarks/>
        public void ShopperHasAccountAsync(string bstrShopperID, object userState) {
            ...
            this.InvokeAsync("ShopperHasAccount", new object[] {
                        bstrShopperID}, this.ShopperHasAccountOperationCompleted, userState);
        }
