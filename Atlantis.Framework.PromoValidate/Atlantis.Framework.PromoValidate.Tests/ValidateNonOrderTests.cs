...
namespace Atlantis.Framework.PromoValidate.Tests
{
  [TestClass]
  [DeploymentItem("atlantis.config")]
  [DeploymentItem("Interop.gdDataCacheLib.dll")]
  [DeploymentItem("Atlantis.Framework.PromoValidate.Impl.dll")]
  public class ValidateNonOrderTests
  {
    ...
    {
      string result;
      string resourcePath = "Atlantis.Framework.PromoValidate.Tests." + dataName;
