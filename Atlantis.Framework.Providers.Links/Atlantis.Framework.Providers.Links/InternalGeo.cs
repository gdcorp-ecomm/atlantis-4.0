...
{
  internal static class InternalGeo
  {
    public static string LookupCountry(string userHostAddress)
    {
      string result = LookupKnownProxyCountryCode(userHostAddress);
      if (string.IsNullOrEmpty(result))
      {
        result = LookupInternalIPCountryCode(userHostAddress);
      }
      return result;
    }
