    ...
    public CrossSellProduct GetCrossSellProduct(CrossSellConfigProductId productId, string iscCode)
    {
      ...
      switch (productId)
      {
        case CrossSellConfigProductId.HOSTING:
          ...
          {
            priceText = string.Format("Just {0}/mo Windows or {1}/mo Linux for 12 months!", _currency.PriceText(hosting_asp_d_1year.MonthlyCurrentPrice), _currency.PriceText(hosting_cgi_d_1year.MonthlyCurrentPrice));
          }
          else
          {
            priceText = string.Format(FORMAT_PRICETEXT, _currency.PriceText(hosting_asp_d_1year.MonthlyCurrentPrice));
          }
        ...
        case CrossSellConfigProductId.WST:
          ...
          priceText = string.Format(FORMAT_PRICETEXT, _currency.PriceText(wst_d_1year.MonthlyCurrentPrice));
        ...
        case CrossSellConfigProductId.CART:
          ...
          priceText = string.Format("Just {0}/mo for 12 months.", _currency.PriceText(cart_E_1year.MonthlyCurrentPrice));
        ...
        case CrossSellConfigProductId.COLD_FUSION:
          ...
          priceText = string.Format(FORMAT_PRICETEXT, _currency.PriceText(coldFusion.MonthlyCurrentPrice));
        ...
        case CrossSellConfigProductId.TRAFFIC_FACTS:
          ...
          priceText = string.Format(FORMAT_PRICETEXT, _currency.PriceText(trafficFacts.MonthlyCurrentPrice));
        ...
        case CrossSellConfigProductId.TRAFFICB:
          ...
          priceText = string.Format("Just {0}/yr.", _currency.PriceText(trafficBlazor_D.UnitPrice));
          ...
          if (savingsPrice > 0)
          {
            savingsText = string.Format("Save nearly {0}!", _currency.PriceText(new CurrencyPrice(savingsPrice, _currency.SelectedDisplayCurrencyInfo, CurrencyPriceType.Transactional)));
          }
        ...
        case CrossSellConfigProductId.EMAIL:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(email_D.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.OFF:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(off_D.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.EEM:
          ...
          priceText = string.Format("Just {0}/mo!", _currency.PriceText(eem_Tier1.MonthlyCurrentPrice));
        ...
        case CrossSellConfigProductId.GROUP_CALENDAR:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(ogc_D.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.SSL_TURBO:
          ...
          priceText = string.Format("Just {0}/yr", _currency.PriceText(ssl_1year_turbo.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.SSL_HIGH:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(ssl_1year_cert.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.CSITE:
          ...
          productName = "c-Site&#174;";
          priceText = string.Format("Just {0}!", _currency.PriceText(copyRight.UnitPrice));
        ...
        case CrossSellConfigProductId.DNA:
          ...
          priceText = string.Format("Memberships Just {0}/yr!", _currency.PriceText(dna.UnitPrice));
        ...
        case CrossSellConfigProductId.PRO_RESELLER:
          ...
          priceText = string.Format("Just {0}!", _currency.PriceText(resellerPro.UnitPrice));
        ...
        case CrossSellConfigProductId.SUPER_RESELLER:
          ...
          priceText = string.Format("Just {0}!", _currency.PriceText(resellerSuper.UnitPrice));
        ...
        case CrossSellConfigProductId.MERCH_ACCT:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(merchantAccount.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.PRIVATE_DOMAINS:
          ...
          priceText = string.Format("Just {0}!", _currency.PriceText(privateDomains.UnitPrice));
        ...
        case CrossSellConfigProductId.DELUXE_WHOIS:
          ...
          priceText = string.Format("Just {0}/yr!", _currency.PriceText(whoIs.YearlyCurrentPrice));
        ...
        case CrossSellConfigProductId.APPRAISAL:
          ...
          priceText = string.Format("Just {0}!", _currency.PriceText(appraisal.UnitPrice));
        ...
        case CrossSellConfigProductId.LOGODESIGN:
          ...
          priceText = string.Format("Just {0}!", _currency.PriceText(logoDesign.UnitPrice));
