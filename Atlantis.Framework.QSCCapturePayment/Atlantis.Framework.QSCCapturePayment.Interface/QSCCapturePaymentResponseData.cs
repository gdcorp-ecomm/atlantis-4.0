...
{
	[DataContract]
	public class QSCCapturePaymentResponseData : IResponseData
	{
		private readonly AtlantisException _ex;
		private responseDetail response;

		public QSCCapturePaymentResponseData(RequestData request, Exception ex)
		{
			_ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
		}

		public QSCCapturePaymentResponseData(AtlantisException aex)
		{
			_ex = aex;
		}

		public QSCCapturePaymentResponseData(responseDetail response)
		{
