...
namespace Atlantis.Framework.QSCRefundOrder.Interface
{
  ...
  public class QSCRefundOrderResponseData : IResponseData
  {
    ...
    public QSCRefundOrderResponseData(RequestData request, Exception ex)
    {
      _ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
    }

    public QSCRefundOrderResponseData(AtlantisException aex)
    {
      _ex = aex;
    }

    public QSCRefundOrderResponseData(responseDetail response)
    {
