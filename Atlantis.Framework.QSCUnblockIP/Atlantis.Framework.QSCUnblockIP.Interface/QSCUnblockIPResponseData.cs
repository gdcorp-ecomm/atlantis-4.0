...
{
	[DataContract]
	public class QSCUnblockIPResponseData : IResponseData
	{
		private readonly AtlantisException _ex;
		private responseDetail response;

		public QSCUnblockIPResponseData(RequestData request, Exception ex)
		{
			_ex = new AtlantisException(request, ex.Source, ex.Message, ex.StackTrace, ex);
		}

		public QSCUnblockIPResponseData(AtlantisException aex)
		{
			_ex = aex;
		}

		public QSCUnblockIPResponseData(responseDetail response)
		{
