  ...
  public class GlobalSiteTest
  {
    ...
    public void TestStayOnGlobalSite1()
    {
      ...
      foreach (var fact in facts.Facts)
      {
        ...
        {
          case "countrySite":
            Assert.IsTrue(Convert.ToString(fact.OutputValue) == "WWW" || Convert.ToString(fact.OutputValue) == "US");
            break;
          default:
    ...
    [TestMethod]
    [DeploymentItem("CountrySiteRedirectTests/CountrySiteRedirectRule.xml")]
    public void TestStayOnGlobalSite2()
    {
      const string MODEL_ID = "mdlCountryRedirect";
      var rules = new XmlDocument();
      // ReSharper disable AssignNullToNotNullAttribute
    ...
    [TestMethod]
    [DeploymentItem("CountrySiteRedirectTests/CountrySiteRedirectRule.xml")]
    public void TestStayOnGlobalSite3()
    {
      const string MODEL_ID = "mdlCountryRedirect";
      var rules = new XmlDocument();
      // ReSharper disable AssignNullToNotNullAttribute
