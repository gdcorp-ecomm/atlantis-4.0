...
namespace Atlantis.Framework.ShopperValidator.Interface
{
  class ModelConstants
  {
    ...
    public static string FACT_FIRST_NAME = "txtFirstName";
    public static string FACT_LAST_NAME = "txtLastName";
    ...
    public static string FACT_LAST_NAME_MAX_LENGTH = "lastNameMaxLength";
