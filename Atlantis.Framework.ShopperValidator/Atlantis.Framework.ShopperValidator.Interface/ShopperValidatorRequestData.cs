 ...
 public class ShopperValidatorRequestData: RequestData
  {
   ...
   public ShopperValidatorRequestData(string shopperId, string sourceURL, string orderId, string pathway, int pageCount, string firstName, string lastName, string username, string password, string confirmPassword, string callInPin, string email)
     ...
     ShopperBaseModel.Add(ModelConstants.MODEL_ID_SHOPPERVALID, new Dictionary<string, string>
                          {
                            ...
                            {ModelConstants.FACT_PIN, callInPin},
