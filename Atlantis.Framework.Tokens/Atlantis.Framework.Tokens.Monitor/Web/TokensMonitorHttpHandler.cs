...
{
  public class TokensMonitorHttpHandler : IHttpHandler
  {
    ...
    private void ResponseHtml(HttpContext context, XDocument monitorData, MonitorDataTypes dataType)
    {
      ...
      string resourcePath = "Atlantis.Framework.Tokens.Monitor.Resources." + dataType.ToString().ToLowerInvariant() + ".xslt";
