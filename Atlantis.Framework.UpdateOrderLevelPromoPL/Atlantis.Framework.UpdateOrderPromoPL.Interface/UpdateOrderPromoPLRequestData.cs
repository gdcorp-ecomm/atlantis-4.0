...
{
    public class UpdateOrderPromoPLRequestData : PLOrderLevelPromoRequestData
    {

      #region Constructors

      public UpdateOrderPromoPLRequestData(string sourceUrl, string pathway, int pageCount)
        : base(sourceUrl, pathway, pageCount)
      {
      }

      public UpdateOrderPromoPLRequestData(string sourceUrl, string pathway, int pageCount, OrderLevelPromoVersion orderLevelPromo)
        :base(sourceUrl, pathway, pageCount, orderLevelPromo)
      {
      }

      public UpdateOrderPromoPLRequestData(string sourceUrl, string pathway, int pageCount, OrderLevelPromoVersion orderLevelPromo, string clientIP)
