...
{
  public class ConditionsMonitorHttpHandler : IHttpHandler
  {
    ...
    private void ResponseOutput(HttpContext context, XDocument monitorData, MonitorDataTypes dataType)
    {
      ...
      if (string.IsNullOrEmpty(outputType) || outputType.ToLowerInvariant() == "xml")
      {
    ...
    private void ResponseHtml(HttpContext context, XDocument monitorData, MonitorDataTypes dataType)
    {
      ...
      string resourcePath = "Atlantis.Framework.Conditions.Monitor.Resources." + dataType.ToString().ToLowerInvariant() + ".xslt";
