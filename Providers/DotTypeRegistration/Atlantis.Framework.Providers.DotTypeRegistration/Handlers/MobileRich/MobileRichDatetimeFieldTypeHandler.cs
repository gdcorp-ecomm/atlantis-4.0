...
{
  public class MobileRichDatetimeFieldTypeHandler : IDotTypeFormFieldTypeHandler
  {
    ...
    private static string ConvertToHtml(IDotTypeFormsField field)
    {
      ...
      result.Append("<input type='datetime' class='max rnd' name='" + field.FieldName + "'>" + "</input>");
      result.Append("</div>");
