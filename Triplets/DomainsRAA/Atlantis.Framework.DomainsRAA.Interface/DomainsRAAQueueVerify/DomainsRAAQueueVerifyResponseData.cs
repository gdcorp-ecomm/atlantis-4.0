...
namespace Atlantis.Framework.DomainsRAA.Interface.DomainsRAAQueueVerify
{
  public class DomainsRAAQueueVerifyResponseData : IResponseData
  {
    private readonly string _responseXml = string.Empty;

    private DomainsRAAQueueVerifyResponseData(AtlantisException exception)
    {
    ...
    private DomainsRAAQueueVerifyResponseData(string responseXml)
    {
    ...
    public static DomainsRAAQueueVerifyResponseData FromData(string responseXml)
    {
      return new DomainsRAAQueueVerifyResponseData(responseXml);
    }

    public static DomainsRAAQueueVerifyResponseData FromData(AtlantisException exception)
    {
      return new DomainsRAAQueueVerifyResponseData(exception);
    }
