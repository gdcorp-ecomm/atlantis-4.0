...
namespace Atlantis.Framework.DotTypeClaims.Interface
{
  public class DotTypeClaimsSchema : IDotTypeClaimsSchema
  {
    ...
    public bool TryGetClaimsXmlByDomain(string domain, out IEnumerable<string> claimsXml)
    {
      return _claimsXmlByDomain.TryGetValue(domain, out claimsXml);
    }

    public DotTypeClaimsSchema(Dictionary<string, string> noticeXml, Dictionary<string, IEnumerable<string>> claimsXml)
    {
