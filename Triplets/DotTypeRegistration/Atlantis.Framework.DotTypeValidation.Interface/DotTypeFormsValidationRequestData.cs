...
{
  public class DotTypeFormsValidationRequestData : RequestData
  {
    ...
    public DotTypeFormsValidationRequestData(string clientApplication, string serverName, int tldId, string phase, Dictionary<string, string> fields)
    {
