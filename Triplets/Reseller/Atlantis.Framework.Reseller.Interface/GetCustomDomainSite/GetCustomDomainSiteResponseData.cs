...
{
  public class GetCustomDomainSiteResponseData : IResponseData, ICustomDomainSite
  {
    ...
    public GetCustomDomainSiteResponseData(string xmlResponse)
    {
      this._xmlResponse = xmlResponse;
      this._retrievalState = CustomDomainSiteRetrieveState.FailedLookup;
    }

    public GetCustomDomainSiteResponseData(AtlantisException exception)
    {
      this._exception = exception;
      this._retrievalState = CustomDomainSiteRetrieveState.ExceptionOccurred;
    }

    public GetCustomDomainSiteResponseData(string xmlResponse, AtlantisException exception)
    {
      this._xmlResponse = xmlResponse;
      this._exception = exception;
      this._retrievalState = CustomDomainSiteRetrieveState.ExceptionOccurred;
    ...
    public GetCustomDomainSiteResponseData(string xmlResponse, int privateLabelId, int shopperPrivateLabelId, string domainNameUrl, CustomDomainType customDomainType, ApplicationState appState, DnsEntry dnsHostEntry, string progId, string shopperId, bool isResellerDnsInternal)
    {
      try
      {
        this._xmlResponse = xmlResponse;
