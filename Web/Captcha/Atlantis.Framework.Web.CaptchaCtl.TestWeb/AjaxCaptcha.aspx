...
<body>
  <div style="padding-left: 100px;">
    ...
    <%--      <div style="margin-bottom: 30px; padding-top: 10px;">
          <div>
            <h1>Localized - Default template - no code/html required</h1>
          </div>
          <div style="border: solid; border-color: black; border-width: 1px; width: 500px; padding: 20px;">
            <atlantis:CaptchaTemplateControl ID="CaptchaTemplateControl4" Locale="bg" runat="server" CaptchaID="instance6" StashRenderLocation="javascriptStash">
            </atlantis:CaptchaTemplateControl>
          </div>
        </div>--%>
  </div>
