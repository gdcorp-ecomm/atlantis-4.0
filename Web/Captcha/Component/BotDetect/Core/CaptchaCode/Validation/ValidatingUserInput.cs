...
{
	[Serializable]
    public class ValidatingUserInputEventArgs : CaptchaEventArgs
    {
        string _currentInstanceId;
        /// <summary>
        /// Globally unique identifier of the current Captcha instance validating the user input
        /// </summary>
        ...
        string _userInput;
        /// <summary>
        /// User input that will be compared to stored codes
        /// </summary>
        ...
        /// <summary>
        /// Captcha codes stored for this captchaId before Captcha validation
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            str.AppendLine("ValidatingUserInputEventArgs {");
