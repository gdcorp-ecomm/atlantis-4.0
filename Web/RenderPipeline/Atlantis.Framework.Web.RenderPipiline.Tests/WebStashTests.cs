...
def
    ...
    [TestMethod]
    public void CssStashTestValidWithStyle()
    {
...
def
    ...
    <hr/>
      ...
      var styleContent = renderedContent.Substring(renderedContent.IndexOf("<hr/>", StringComparison.OrdinalIgnoreCase) + 5).TrimStart('\r', '\n').Trim();

      Assert.IsTrue(!renderedContent.Contains("<atlantis:webstash type=\"css\">") &&
                    !renderedContent.Contains("</atlantis:webstash>") &&
                    styleContent.Contains("abc") && styleContent.Contains("def") && styleContent.Contains("</head>")
                   );
    }
...
def
    ...
    [TestMethod]
    public void CssAndJsStashTestValidText()
    {
      const string content = @"<head>
    <div>
      <atlantis:webstash type=""js"">
  ...
  <body>
    <atlantis:webstash type=""css"">
      ...
      Assert.IsTrue(!renderedContent.Contains("<atlantis:webstash type=\"css\">") &&
                    !renderedContent.Contains("</atlantis:webstash>") &&
                    !renderedContent.Contains("<atlantis:webstash type=\"js\">") &&
                    styleContent.Contains("abc") && styleContent.Contains("def") && styleContent.Contains("ghi") && styleContent.Contains("</head>") && styleContent.Contains("</body>")
                   );
    }
  }
}
